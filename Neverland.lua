...
url = 'https://raw.githubusercontent.com/NeverlandTele/Neverland/master/Neverland.lua'
...
if text == (database:get(bot_id.."Neverland:Name:Bot") or "ماتركس") then
Namebot = (database:get(bot_id.."Neverland:Name:Bot") or "ماتركس")
local namebot = {
'لابسك لتلح',
'لاتوصخ اسمي',
'هاقلبي؟ كول',
...
if text == 'تحديث ماتركس' and DevNeverland(msg) then
download_to_file('https://raw.githubusercontent.com/NeverlandTele/Neverland/master/Neverland.lua','Neverland.lua') 
...
https.request('https://evzxar.ml/Youtube/XCGCC.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin..'&user='..msg.sender_user_id_)
end
...
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'مطور السورس' or text == 'اريد بوت تمبلر' or text == 'سورس ماتركس' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مطور السورس' or text == 'اريد انصب بوت' or text == 'سورس ماتركس' or text == '@XCGCC' then
...
x = {} 
x.inline_keyboard = {
{{text ="Bot Developer",url="https://t.me/XCGCC"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&photo='..bo.photos_[0].sizes_[1].photo_.persistent_id_..'&caption='..URL.escape(Text)..'&message_id='..msg.id_..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(x)) 
else
send(msg.chat_id_, msg.id_,Text)
...
if DevNeverland(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/NeverlandTele/files_Neverland/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/NeverlandTele/files_Neverland/master/files_Neverland/"..file)
if res == 200 then
...
os.execute('wget https://raw.githubusercontent.com/NeverlandTele/Neverland/master/Neverland.lua')
os.execute('wget https://raw.githubusercontent.com/NeverlandTele/Neverland/master/start.lua')
dofile('Neverland.lua')  
return false
end
if text == "تحديث ↝" then
...
local Name_Bot = (database:get(bot_id.."Neverland:Name:Bot") or "ماتركس")
