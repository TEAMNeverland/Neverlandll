...
key = {{{text = ''..b.first_name_..' ',url="t.me/"..UserName or XCGCC}}}
...
{{text = '↝مطور السورس↝', url="t.me/XCGCC"}},
}
...
{{text = 'Developer Source !', url="https://t.me/XCGCC"}},
}
send_inline_key(msg.chat_id_,"البوت "..texte.." من سورس [Neverland team](https://t.me/TEAM_Neverland)",nil,key,msg.id_/2097152/0.5)
end,nil)   
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'مطور السورس' or text == 'اريد بوت تمبلر' or text == 'سورس نيفرلاند' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مطور السورس' or text == 'اريد انصب بوت' or text == 'سورس نيفرلاند' or text == '@XCGCC' then
...
x = {} 
x.inline_keyboard = {
{{text = ''..data.first_name_..'',url="https://t.me/XCGCC"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&photo='..bo.photos_[0].sizes_[1].photo_.persistent_id_..'&caption='..URL.escape(Text)..'&message_id='..msg.id_..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(x)) 
else
send(msg.chat_id_, msg.id_,Text)
...
if text == 'مبرمج السورس' or text == '@XCGCC' then  
key = {
...
send(msg.chat_id_, msg.id_,' ✦┇[تحديثات ﭑݪسورس](https://t.me/infoo_Neverland) \n ✦┇[قناه ﭑݪسورس](https://t.me/TEAM_Neverland)')
end
if text == 'المطور ↝' or text == 'مطور' or text == 'المطورين' then
