...
local msg_id = msg.id_/2097152/0.5 
https.request('https://api-david.ml/Neverland/ApiYt.php?Put=Search&token='..token..'&chat_id='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&msg='..msg_id)
end
end
