...
local msg_id = msg.id_/2097152/0.5 
https.request('https://api-david.ml/Neverland/ApiYt.php?Put=Search&token='..token..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
end
...
https.request('https://api-david.ml/Neverland/ApiYt.php?Put=Photo&token='..token..'&Chat_id='..Chat_id..'&msg_idd='..msg_idd..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request('https://api-david.ml/Neverland/ApiYt.php?Put=Video&token='..token..'&Chat_id='..Chat_id..'&msg_idd='..msg_idd..'&Url='..Url..'&Name='..DirName)
elseif Text and Text:match('dl:vo/(.*)') then
local Id_Link = Text:match('dl:vo/(.*)') 
https.request("https://api.telegram.org/bot"..token..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("‹ جار تحميل النتائج يرجى الانتظار .. ›")..'&show_alert=true')
https.request('https://api-david.ml/Neverland/ApiYt.php?Put=Audio&token='..token..'&Chat_id='..Chat_id..'&msg_idd='..msg_idd..'&Url='..Url..'&Name='..DirName)
elseif Text and Text:match('dl:au/(.*)') then
local Id_Link = Text:match('dl:au/(.*)')
https.request("https://api.telegram.org/bot"..token..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("‹ جار تحميل النتائج يرجى الانتظار .. ›")..'&show_alert=true')
DeleteMessage(data.chat_id_,{[0] = Msg_id})    
https.request('https://api-david.ml/Neverland/ApiYt.php?Put=Voice&token='..token..'&Chat_id='..Chat_id..'&msg_idd='..msg_idd..'&Url='..Url..'&Name='..DirName)
end
